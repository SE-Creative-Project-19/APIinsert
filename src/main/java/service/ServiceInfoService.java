...
public class ServiceInfoService {
    ...
    public ServiceInfoService(ServiceInfoDAO dao, VolunteerDAO volunteerDAO) { //TODO VolunteerDAO를 통해서 시간이 지난 봉사활동들을 완료해야 해서 추가하였습니다.
        this.dao = dao;
    ...
    public void updateServiceInfoByTime(){
        dao.updateServiceInfoByTime();//TODO 12시를 기준으로 봉사 모집 기간이 완료된 serviceInfo를 변경합니다.
        volunteerDAO.updateVolunteerByTime();//TODO 12시를 기준으로 봉사 활동 기간이 완료된 volunteer를 별점 미등록 상태로 변경합니다.
    }
